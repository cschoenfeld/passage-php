...
class Passage {
     ...
     */
    public function createMagicLink(CreateMagicLinkRequest $create_magic_link_request) {
     ...
     */
    public function revokeUserRefreshTokens(string $user_id) {
     ...
     * @return null|Model401Error|Model404Error|Model500Error
     */
    public function deleteUserDevice(string $user_id, string $device_id) {
     ...
     */
    public function listUserDevices(string $user_id) {
     ...
     * @return UserInfo|Model401Error|Model404Error|Model500Error
     */
    public function activateUser(string $user_id) {
     ...
     * @return UserInfo|Model401Error|Model404Error|Model500Error
     */
    public function createUser(CreateUserRequest $create_user_request) {
     ...
     * @return UserInfo|Model401Error|Model404Error|Model500Error
     */
    public function deactivateUser(string $user_id) {
     ...
     * @return UserInfo|Model401Error|Model404Error|Model500Error
     */
    public function updateUser(string $user_id, UpdateUserRequest $update_user_request) {
